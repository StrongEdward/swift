...
void AccountItemDelegate::paintExpansionTriangle(QPainter* painter, const QRect& region, int width, int height, bool expanded) const {
...
void AccountItemDelegate::paintShadowText(QPainter* painter, const QRect& region, const QString& text) const {
...
const int AccountItemDelegate::groupCornerRadius_ = 0;
